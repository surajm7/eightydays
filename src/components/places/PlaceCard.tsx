    ...
    >
      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="flex space-x-2 mt-3 pt-3 border-t border-gray-100">
          <button 
            className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 text-xs sm:text-sm py-2 px-2 sm:px-3 rounded transition-colors text-center"
            onClick={(e) => {
              e.stopPropagation()
          ...
          <button 
            className="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-xs sm:text-sm py-2 px-2 sm:px-3 rounded transition-colors text-center"
            onClick={(e) => {
              e.stopPropagation()
